...
def process_batch(lines, img_path):
    num = len(lines)
    batch = np.zeros((num, 12, 112, 112, 3), dtype='float32')
...
model.save_weights('C:/Users/onure/PycharmProjects/ImageClassification/4-1Videolar-20-15frameVGG16.h5')
