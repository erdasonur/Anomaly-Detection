...
def c3d_model():
    ...
    x = Dropout(0.6)(x)
    x = Dense(32, kernel_initializer='glorot_normal', kernel_regularizer=l2(0.001), activation='relu')(x)
    x = Dropout(0.6)(x)
...
model.save_weights('C:/Users/onure/PycharmProjects/ImageClassification/4-1Videolar(agdeneme2)_frame20-15.h5')
