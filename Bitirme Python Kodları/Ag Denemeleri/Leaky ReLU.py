...
def c3d_model():
    ...
    x = Flatten()(x)
    x = Dense(512, input_dim=4096, kernel_initializer='glorot_normal', kernel_regularizer=l2(0.001))(x)
    x = LeakyReLU(alpha=0.1)(x)
    x = Dropout(0.6)(x)
...
model.save_weights('C:/Users/onure/PycharmProjects/ImageClassification/4-1Videolar-20-15frameLeakyRelU2.h5')
