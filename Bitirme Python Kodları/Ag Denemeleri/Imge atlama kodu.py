...
def process_batch(lines, img_path):
    num = len(lines)
    batch = np.zeros((num, 8, 112, 112, 3), dtype='float32')
...
train_file = 'C:/Users/onure/PycharmProjects/ImageClassification/Bir_atlamali_imge(8-5frame)_train.txt'
test_file = 'C:/Users/onure/PycharmProjects/ImageClassification/Bir_atlamali_imge(8-5frame)_test.txt'
...
model.save_weights('C:/Users/onure/PycharmProjects/ImageClassification/4-1Videolar(agdeneme1)_frame8-5(birimgeatlamali).h5')
