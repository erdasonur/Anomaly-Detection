...
def c3d_model():
    ...
    x = Conv3D(64, (3, 3, 3), strides=(2, 2, 1), padding='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(inputs)
    
    x = Conv3D(64, (3, 3, 3), strides=(2, 2, 2), padding='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(x)

    x = Conv3D(128, (3, 3, 3), strides=(2, 2, 1), padding='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(x)

    x = Conv3D(128, (3, 3, 3), strides=(2, 2, 2), padding='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(x)
    ...
    x = Conv3D(512, (3, 3, 3), strides=(2, 2, 2), padding='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(x)
...
model.save_weights('C:/Users/onure/PycharmProjects/ImageClassification/4-1Videolar-20-15frame_poolingyoklugu.h5')
