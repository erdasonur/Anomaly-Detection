...
def c3d_model():
    ...
    x = Conv3D(64, (3, 3, 3), strides=(1, 1, 1), border_mode='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(inputs)
    x = MaxPool3D((2, 2, 1), strides=(2, 2, 1), border_mode='valid')(x)

    x = Conv3D(128, (3, 3, 3), strides=(1, 1, 1), border_mode='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(x)
    x = MaxPool3D((2, 2, 2), strides=(2, 2, 2), border_mode='valid')(x)

    x = Conv3D(256, (3, 3, 3), strides=(1, 1, 1), border_mode='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(x)
    x = Conv3D(256, (3, 3, 3), strides=(1, 1, 1), border_mode='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(x)
    x = MaxPool3D((2, 2, 2), strides=(2, 2, 2), border_mode='valid')(x)

    x = Conv3D(512, (3, 3, 3), strides=(1, 1, 1), border_mode='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(x)
    x = Conv3D(512, (3, 3, 3), strides=(1, 1, 1), border_mode='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(x)
    x = MaxPool3D((2, 2, 2), strides=(2, 2, 2), border_mode='valid')(x)
    ...
    x = ZeroPadding3D(padding=(1, 1, 0))(x)
    x = MaxPool3D((2, 2, 2), strides=(2, 2, 2), border_mode='valid')(x)
...
model.save_weights('C:/Users/onure/PycharmProjects/ImageClassification/4-1Videolar(agdeneme1)_frame20-15.h5')
